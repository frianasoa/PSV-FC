...
//try to optimizing switch but,C# switch is more effective than
//delegate function pointer! (by nc)
//Comment the line above to use delegate function pointer.
#define USE_SWITCH
...
public class ProcessorNes6502
{
	...
	//Helper funtions
	private delegate void OpHandler();
    static OpHandler[] myOpHandler;
...
#else 
				if(currentOpcode>=0&&currentOpcode<0xff)
					myOpHandler[currentOpcode]();
				else
					OpcodeNOP();
#endif
			}					
	...
	private void SetOpcode(){
			//set op code
			myOpHandler = new OpHandler[0xff];
			for(int i=0;i<0xff;i++)
				myOpHandler[i] = OpcodeNOP;
					
			myOpHandler[0x01]=OpcodeORA;  
	        myOpHandler[0x05]=OpcodeORA;   //0x05
			myOpHandler[0x06]=OpcodeASL; 
			myOpHandler[0x08]=OpcodePHP; 
			myOpHandler[0x09]=OpcodeORA; 
			myOpHandler[0x0a]=OpcodeASL;  
			myOpHandler[0x0d]=OpcodeORA;  
			myOpHandler[0x0e]=OpcodeASL;    //0x0E
			myOpHandler[0x10]=OpcodeBPL;  
			myOpHandler[0x11]=OpcodeORA;  
			myOpHandler[0x15]=OpcodeORA;  
			myOpHandler[0x16]=OpcodeASL;  
			myOpHandler[0x18]=OpcodeCLC;  
			myOpHandler[0x19]=OpcodeORA;
			myOpHandler[0x1d]=OpcodeORA; 
			myOpHandler[0x1e]=OpcodeASL;  
			myOpHandler[0x20]=OpcodeJSR;   //0x20
			myOpHandler[0x21]=OpcodeAND;  
			myOpHandler[0x24]=OpcodeBIT;  
			myOpHandler[0x25]=OpcodeAND;  
			myOpHandler[0x26]=OpcodeROL;  
			myOpHandler[0x28]=OpcodePLP;  
			myOpHandler[0x29]=OpcodeAND;   //0x29
			myOpHandler[0x2a]=OpcodeROL;  
			myOpHandler[0x2c]=OpcodeBIT;  
			myOpHandler[0x2d]=OpcodeAND;  
			myOpHandler[0x2e]=OpcodeROL;  
			myOpHandler[0x30]=OpcodeBMI;
			myOpHandler[0x31]=OpcodeAND;  
			myOpHandler[0x32]=OpcodeNOP;   //0x32
			myOpHandler[0x33]=OpcodeNOP;  
			myOpHandler[0x34]=OpcodeNOP;  
			myOpHandler[0x35]=OpcodeAND;  
			myOpHandler[0x36]=OpcodeROL;  
			myOpHandler[0x38]=OpcodeSEC;  
			myOpHandler[0x39]=OpcodeAND;  
			myOpHandler[0x3d]=OpcodeAND;  
			myOpHandler[0x3e]=OpcodeROL;  
			myOpHandler[0x40]=OpcodeRTI;  
			myOpHandler[0x41]=OpcodeEOR;  
			myOpHandler[0x45]=OpcodeEOR;  
			myOpHandler[0x46]=OpcodeLSR;  
			myOpHandler[0x48]=OpcodePHA;  
			myOpHandler[0x49]=OpcodeEOR;  
			myOpHandler[0x4a]=OpcodeLSR;  
			myOpHandler[0x4c]=OpcodeJMP;  
			myOpHandler[0x4d]=OpcodeEOR;  //0x4D
			myOpHandler[0x4e]=OpcodeLSR;  
			myOpHandler[0x50]=OpcodeBVC;  
			myOpHandler[0x51]=OpcodeEOR;  
			myOpHandler[0x55]=OpcodeEOR;  
			myOpHandler[0x56]=OpcodeLSR;  //0x56
			myOpHandler[0x58]=OpcodeCLI;  
			myOpHandler[0x59]=OpcodeEOR;  
			myOpHandler[0x5d]=OpcodeEOR; 
			myOpHandler[0x5e]=OpcodeLSR;  
			myOpHandler[0x60]=OpcodeRTS;  
			myOpHandler[0x61]=OpcodeADC;  
			myOpHandler[0x65]=OpcodeADC;  
			myOpHandler[0x66]=OpcodeROR;  
			myOpHandler[0x68]=OpcodePLA;  //0x68
			myOpHandler[0x69]=OpcodeADC;  
			myOpHandler[0x6a]=OpcodeROR;  
			myOpHandler[0x6c]=OpcodeJMP;  
			myOpHandler[0x6d]=OpcodeADC;  
			myOpHandler[0x6e]=OpcodeROR;  
			myOpHandler[0x70]=OpcodeBVS;  
			myOpHandler[0x71]=OpcodeADC;  //0x71
			myOpHandler[0x75]=OpcodeADC;  
			myOpHandler[0x76]=OpcodeROR;  
			myOpHandler[0x78]=OpcodeSEI;  
			myOpHandler[0x79]=OpcodeADC;  
			myOpHandler[0x7d]=OpcodeADC;  
			myOpHandler[0x7e]=OpcodeROR;  
			myOpHandler[0x81]=OpcodeSTA;  
			myOpHandler[0x84]=OpcodeSTY;  
			myOpHandler[0x85]=OpcodeSTA;  
			myOpHandler[0x86]=OpcodeSTX;  
			myOpHandler[0x88]=OpcodeDEY;  
			myOpHandler[0x8a]=OpcodeTXA;  
			myOpHandler[0x8c]=OpcodeSTY;  //0x8C
			myOpHandler[0x8d]=OpcodeSTA; 
			myOpHandler[0x8e]=OpcodeSTX;
			myOpHandler[0x90]=OpcodeBCC;  
			myOpHandler[0x91]=OpcodeSTA;  
			myOpHandler[0x94]=OpcodeSTY;  
			myOpHandler[0x95]=OpcodeSTA;  //0x95
			myOpHandler[0x96]=OpcodeSTX;  
			myOpHandler[0x98]=OpcodeTYA;  
			myOpHandler[0x99]=OpcodeSTA;  
			myOpHandler[0x9a]=OpcodeTXS;  
			myOpHandler[0x9d]=OpcodeSTA;  
			myOpHandler[0xa0]=OpcodeLDY;  
			myOpHandler[0xa1]=OpcodeLDA;  
			myOpHandler[0xa2]=OpcodeLDX;  
			myOpHandler[0xa4]=OpcodeLDY;  
			myOpHandler[0xa5]=OpcodeLDA;  
			myOpHandler[0xa6]=OpcodeLDX;  
			myOpHandler[0xa8]=OpcodeTAY;  
			myOpHandler[0xa9]=OpcodeLDA;  
			myOpHandler[0xaa]=OpcodeTAX;  
			myOpHandler[0xac]=OpcodeLDY;  
			myOpHandler[0xad]=OpcodeLDA;  
			myOpHandler[0xae]=OpcodeLDX;  
			myOpHandler[0xb0]=OpcodeBCS;  //0xB0
			myOpHandler[0xb1]=OpcodeLDA;  
			myOpHandler[0xb4]=OpcodeLDY;  
			myOpHandler[0xb5]=OpcodeLDA;  
			myOpHandler[0xb6]=OpcodeLDX;  
			myOpHandler[0xb8]=OpcodeCLV;  
			myOpHandler[0xb9]=OpcodeLDA;  //0xB9
			myOpHandler[0xba]=OpcodeTSX;  
			myOpHandler[0xbc]=OpcodeLDY;  
			myOpHandler[0xbd]=OpcodeLDA;  
			myOpHandler[0xbe]=OpcodeLDX;  
			myOpHandler[0xc0]=OpcodeCPY;  
			myOpHandler[0xc1]=OpcodeCMP;  
			myOpHandler[0xc4]=OpcodeCPY;  
			myOpHandler[0xc5]=OpcodeCMP;  
			myOpHandler[0xc6]=OpcodeDEC;  
			myOpHandler[0xc8]=OpcodeINY;  
			myOpHandler[0xc9]=OpcodeCMP;  
			myOpHandler[0xca]=OpcodeDEX;  
			myOpHandler[0xcc]=OpcodeCPY;  
			myOpHandler[0xcd]=OpcodeCMP;  
			myOpHandler[0xce]=OpcodeDEC;  
			myOpHandler[0xd0]=OpcodeBNE;  
			myOpHandler[0xd1]=OpcodeCMP;  
			myOpHandler[0xd5]=OpcodeCMP;  
			myOpHandler[0xd6]=OpcodeDEC;  
			myOpHandler[0xd8]=OpcodeCLD;  
			myOpHandler[0xd9]=OpcodeCMP;  
			myOpHandler[0xdd]=OpcodeCMP;  //0xDD
			myOpHandler[0xde]=OpcodeDEC;  
			myOpHandler[0xe0]=OpcodeCPX;  
			myOpHandler[0xe1]=OpcodeSBC;  
			myOpHandler[0xe4]=OpcodeCPX;  
			myOpHandler[0xe5]=OpcodeSBC;  
			myOpHandler[0xe6]=OpcodeINC;  //0xE6
			myOpHandler[0xe8]=OpcodeINX;  
			myOpHandler[0xe9]=OpcodeSBC;  
			myOpHandler[0xec]=OpcodeCPX;  
			myOpHandler[0xed]=OpcodeSBC;  
			myOpHandler[0xee]=OpcodeINC;  
			myOpHandler[0xf0]=OpcodeBEQ;  
			myOpHandler[0xf1]=OpcodeSBC;  
			myOpHandler[0xf5]=OpcodeSBC;  
			myOpHandler[0xf6]=OpcodeINC;  
			myOpHandler[0xf8]=OpcodeSED;  //0xF8
			myOpHandler[0xf9]=OpcodeSBC;  
			myOpHandler[0xfd]=OpcodeSBC;  
			myOpHandler[0xfe]=OpcodeINC;
	}
